...
function HeroSection() {
  ...
  return (
    <section className="hero-section flex justify-center items-center h-screen bg-cover bg-center">
      <div className="hero-bg" style={{ backgroundImage: `url(${heroImage})` }}></div>
      <div className="container mx-auto px-4 py-16 text-center relative z-10">
        <h1 className="text-4xl font-bold text-primary-950 mb-4">Turning Surplus into Support</h1>
